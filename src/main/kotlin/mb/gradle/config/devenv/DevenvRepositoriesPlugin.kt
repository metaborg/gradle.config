...
class DevenvRepositoriesPlugin : Plugin<Project> {
    ...
    private fun configure(project: Project) {
        ...
        project.tasks.register<RepositoryTask>("update") {
            ...
            description =
                "For each repository (with update=true): check out the repository to the correct branch and pull from origin, or clone the repository if it has not been cloned yet."
        }
        ...
        project.tasks.register<PushRepositoryTask>("push") {
            ...
            description =
                "For each repository (with update=true): push the current local branch (and optionally tags) to the main remote."
        }
    ...
    private fun RepositoryTask.getSelectedRepositories(
        rootRepository: RootRepository,
        allowNotUpdated: Boolean = false
